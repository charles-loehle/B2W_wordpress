...
$num_title                    = get_field('num_title');
$num_subtitle                 = get_field('num_subtitle');
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-8 col-md-6">
        ...
        <h3><?php echo $num_title; ?> <small><?php echo $num_subtitle; ?></small></h3>

        <div class="row">
          <div class="col-xs-4">
            <div class="num">
              <div class="num-content"><?php echo $num_students; ?><span></span>
              </div><!-- /.num-content -->
            </div><!-- /.num -->
          </div><!-- /.col-xs-4-->
          ...
          <div class="col-xs-4">
            <div class="num">
              <div class="num-content"><?php echo $num_reviews; ?><span></span>
              </div><!-- /.num-content -->
            </div><!-- /.num -->
          </div><!-- /.col-xs-4-->
          ...
          <div class="col-xs-4">
            <div class="num">
              <div class="num-content"><?php echo $num_courses; ?><span></span>
              </div><!-- /.num-content -->
            </div><!-- /.num -->
          </div><!-- /.col-xs-4-->
        </div><!-- /.row -->
